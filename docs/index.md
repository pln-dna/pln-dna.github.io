...
You swab your cheek and send the a small vial with skin cells off to the lab. They test it and produce results - which are nothing more than a set of numbers. The numbers themselves really aren't that important, it is how they compare to other people's results that is key.

Genetic genealogy is all about 'matching', i.e. your results are compared with other people's and if there are similarities that imply you share some genealogy - then your contact details are made available to each other. That's the basics of it.  In Y-DNA testing, a match is regarded as someone that shares a common patrilineal ancestor within a genealogical timeframe, usually 1000 years or less.

In a Y-DNA surname project, the administrator can work out how and when you are related - with the right tests.
